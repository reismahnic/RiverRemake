...
define config.name = _("Throw Me In the River")
...
define build.name = "ThrowMeIntheRiver"
...
define config.main_menu_music = "audio/music/scene2happyEdited.ogg"
...
define config.save_directory = "ThrowMeIntheRiver-1533499197"
